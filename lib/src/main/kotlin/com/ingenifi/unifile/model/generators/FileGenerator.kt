...
data class FileGenerator(val config: SectionGeneratorConfig, val number: Int, val file: File, val headingName: HeadingName, val summary : String? = null, val detail: String = file.readText()) : SectionGenerator,
