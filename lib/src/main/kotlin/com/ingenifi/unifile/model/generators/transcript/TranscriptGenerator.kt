...
) : SectionsGenerator by FileGenerator(config, number, file, headingName, summary = SummaryText.Summary(transcript.summary), detail = DetailText.Detail(transcript.detail)) {
    companion object {
